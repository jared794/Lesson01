...
QUnit.test( "Union Test", function( assert ) {
    ...
    var expectedList = ["Bill", "Mark", "Susan", "Mike", "Steve",
                        "Jane", "Bob", "Wayne", "Connie", "Jim",
                        "Annabelle", "Harriet", "Jean", "Mary", "Peter",
                        "Sam", "Ann", "James", "Joseph", "Bridger", "Luke",
                        "Issac", "Emma", "Ruth"]
    ...
    console.log("Set Operations", setOperations.union(listA, listB));
